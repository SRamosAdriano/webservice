...
Sumário: Exemplo de um webservice <br>
Source: http://goo.gl/jwnyKu

Informação
-----------

É um projeto de webservice, projeto Maven 3 com Java EE 7 no JBoss Enterprise Application Platform 6 ou JBoss AS 7.  

Este projeto está configurado para um aplicativo Java EE 7 compatível com JSF 2.0, CDI 1.0, EJB 3.1, JPA 2.0 e Bean Validation 1.0. 
...
- Acesse o arquivo webservice-ds.xml no projeto webservice:
